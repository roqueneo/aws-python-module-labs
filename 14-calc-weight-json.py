# from helpers.json_file_handler import read_json_file
import helpers.json_file_handler as json_helper

# data = read_json_file('./resources/insulin.json')
data = json_helper.read_json_file('./resources/insulin.json')
